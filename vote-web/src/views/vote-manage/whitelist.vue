<template>
  ...
  <!--  <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="用户名：">
            <el-input style="width: 203px" v-model="listQuery.voteId" placeholder="请输入投票ID"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>-->
    ...
    <el-dialog title="添加白名单" :visible.sync="whiteDialog">
      <el-upload
        class="upload-demo"
        ref="upload"
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        getWhitePage(this.listQuery).then(response => {
